          ...
          <div className="p-8">
            ...
            <div className="mt-10 text-center text-gray-600">
              <p>
                ...
                <a onClick={handleLoginClick} className="text-purple-600 hover:text-purple-800 font-medium cursor-pointer">
                  Log in
                </a>
              </p>
            </div>
        ...
        <div className="text-center mt-8 text-white">
          <p>
            ...
            <a 
              ...
              className="text-purple-300 hover:text-purple-100 cursor-pointer"
            >
              Terms of Service
            </a>{' '}
            and{' '}
